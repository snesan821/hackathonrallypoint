  ...
  if (!item) {
    return (
      <div className="site-wrap py-8 text-center">
        ...
        <Link href="/feed" className="mt-4 inline-block text-primary hover:text-primary-container">
          ← Back to Feed
        </Link>
      </div>
    )
        ...
        <div className="site-wrap py-8">
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              {commentCount > 0 && <span className="text-sm text-on-surface-variant">{commentCount} comments</span>}
            </div>
          </div>
